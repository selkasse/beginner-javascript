...
var error = document.querySelector('.error'); // create an array to hold the state
...
function handleSubmit(e) {
  ...
  letters.forEach(checkAllSpaces); // if only the first chracter is a space,
...
function deleteItem(id) {
  console.log(id); // update the items array without this id
...
list.addEventListener('itemsUpdated', mirrorToLocalStorage); // Event Delegation
...
},{}]},{},["../../../../../../../home/idev/.nvm/versions/node/v13.5.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","shopping.js"], null)
